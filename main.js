...
// Cuando consumimos un JSON SIEMPRE es asyncrono.
// tenemos que crear una funcion asyncrona para que se ejecuten los datos al mismo tiempo que JS
async function obtenerObjetos(){
    // crear una variable para guardar el endpoint = direccion donde estan los datos.
    // await = espera a que llegue y despues ejecutalo.
    // el fetch es el metodo que ofrece javascript nativamente 
    // el fetch es una promesa que se crea y necesita una respuesta para cumplirla.
